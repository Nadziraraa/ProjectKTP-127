 ...
 */
package unu.jogja.projectktp.coba;
...
import unu.jogja.projectktp.coba.exceptions.NonexistentEntityException;
import unu.jogja.projectktp.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("unu.jogja_projectktp_jar_0.0.1-SNAPSHOTPU");
